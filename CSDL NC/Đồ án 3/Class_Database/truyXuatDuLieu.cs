...
namespace truyXuatDuLieu
{
    ...
    public class truyXuatDuLieu
    {
        ...
        {
            sConnectionString = System.Configuration.ConfigurationManager.AppSettings[Module].ToString();
        }
        /// <summary>
        ...
        /// DataTable
        /// </return>>
        protected DataTable ThucThiStoreTraVeBang(string TenStoreProcedure, SqlParameter[] sqlParam)
        {
